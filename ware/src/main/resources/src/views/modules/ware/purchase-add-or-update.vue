<template>
  <el-dialog
    ...
    <el-form-item label="采购人id" prop="assigneeId">
      <el-input placeholder="采购人id" v-model="dataForm.assigneeId"></el-input>
    </el-form-item>
    <el-form-item label="采购人名" prop="assigneeName">
      <el-input placeholder="采购人名" v-model="dataForm.assigneeName"></el-input>
    </el-form-item>
    <el-form-item label="联系方式" prop="phone">
      <el-input placeholder="联系方式" v-model="dataForm.phone"></el-input>
    </el-form-item>
    ...
    <el-form-item label="总金额" prop="amount">
      <el-input placeholder="总金额" v-model="dataForm.amount"></el-input>
    </el-form-item>
    <el-form-item label="创建日期" prop="createTime">
      <el-input placeholder="创建日期" v-model="dataForm.createTime"></el-input>
    </el-form-item>
    <el-form-item label="更新日期" prop="updateTime">
      <el-input placeholder="更新日期" v-model="dataForm.updateTime"></el-input>
    </el-form-item>
    </el-form>
