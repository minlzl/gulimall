  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button @click="addOrUpdateHandle()" type="primary" v-if="isAuth('member:memberreceiveaddress:save')">新增</el-button>
        <el-button :disabled="dataListSelections.length <= 0" @click="deleteHandle()" type="danger" v-if="isAuth('member:memberreceiveaddress:delete')">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
