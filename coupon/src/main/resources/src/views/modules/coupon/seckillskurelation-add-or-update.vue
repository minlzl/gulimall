<template>
  <el-dialog
    ...
    <el-form-item label="活动id" prop="promotionId">
      <el-input placeholder="活动id" v-model="dataForm.promotionId"></el-input>
    </el-form-item>
    <el-form-item label="活动场次id" prop="promotionSessionId">
      <el-input placeholder="活动场次id" v-model="dataForm.promotionSessionId"></el-input>
    </el-form-item>
    <el-form-item label="商品id" prop="skuId">
      <el-input placeholder="商品id" v-model="dataForm.skuId"></el-input>
    </el-form-item>
    <el-form-item label="秒杀价格" prop="seckillPrice">
      <el-input placeholder="秒杀价格" v-model="dataForm.seckillPrice"></el-input>
    </el-form-item>
    <el-form-item label="秒杀总量" prop="seckillCount">
      <el-input placeholder="秒杀总量" v-model="dataForm.seckillCount"></el-input>
    </el-form-item>
    <el-form-item label="每人限购数量" prop="seckillLimit">
      <el-input placeholder="每人限购数量" v-model="dataForm.seckillLimit"></el-input>
    </el-form-item>
