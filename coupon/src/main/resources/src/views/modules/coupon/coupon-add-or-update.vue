<template>
  <el-dialog
    ...
    <el-form-item label="优惠卷类型[0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券]" prop="couponType">
      <el-input placeholder="优惠卷类型[0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券]" v-model="dataForm.couponType"></el-input>
    </el-form-item>
    <el-form-item label="优惠券图片" prop="couponImg">
      <el-input placeholder="优惠券图片" v-model="dataForm.couponImg"></el-input>
    </el-form-item>
    <el-form-item label="优惠卷名字" prop="couponName">
      <el-input placeholder="优惠卷名字" v-model="dataForm.couponName"></el-input>
    </el-form-item>
    <el-form-item label="数量" prop="num">
      <el-input placeholder="数量" v-model="dataForm.num"></el-input>
    </el-form-item>
    <el-form-item label="金额" prop="amount">
      <el-input placeholder="金额" v-model="dataForm.amount"></el-input>
    </el-form-item>
    <el-form-item label="每人限领张数" prop="perLimit">
      <el-input placeholder="每人限领张数" v-model="dataForm.perLimit"></el-input>
    </el-form-item>
    <el-form-item label="使用门槛" prop="minPoint">
      <el-input placeholder="使用门槛" v-model="dataForm.minPoint"></el-input>
    </el-form-item>
    ...
    <el-form-item label="使用类型[0->全场通用；1->指定分类；2->指定商品]" prop="useType">
      <el-input placeholder="使用类型[0->全场通用；1->指定分类；2->指定商品]" v-model="dataForm.useType"></el-input>
    </el-form-item>
    <el-form-item label="备注" prop="note">
      <el-input placeholder="备注" v-model="dataForm.note"></el-input>
    </el-form-item>
    <el-form-item label="发行数量" prop="publishCount">
      <el-input placeholder="发行数量" v-model="dataForm.publishCount"></el-input>
    </el-form-item>
    <el-form-item label="已使用数量" prop="useCount">
      <el-input placeholder="已使用数量" v-model="dataForm.useCount"></el-input>
    </el-form-item>
    <el-form-item label="领取数量" prop="receiveCount">
      <el-input placeholder="领取数量" v-model="dataForm.receiveCount"></el-input>
    </el-form-item>
    <el-form-item label="可以领取的开始日期" prop="enableStartTime">
      <el-input placeholder="可以领取的开始日期" v-model="dataForm.enableStartTime"></el-input>
    </el-form-item>
    <el-form-item label="可以领取的结束日期" prop="enableEndTime">
      <el-input placeholder="可以领取的结束日期" v-model="dataForm.enableEndTime"></el-input>
    </el-form-item>
    ...
    <el-form-item label="可以领取的会员等级[0->不限等级，其他-对应等级]" prop="memberLevel">
      <el-input placeholder="可以领取的会员等级[0->不限等级，其他-对应等级]" v-model="dataForm.memberLevel"></el-input>
    </el-form-item>
    <el-form-item label="发布状态[0-未发布，1-已发布]" prop="publish">
      <el-input placeholder="发布状态[0-未发布，1-已发布]" v-model="dataForm.publish"></el-input>
    </el-form-item>
    </el-form>
